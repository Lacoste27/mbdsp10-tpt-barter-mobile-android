...
import mbds.barter.ui.post.placeholder.PlaceholderContent.PlaceholderItem;
import mbds.barter.databinding.FragmentPostBinding;
...
public class PostListRecyclerViewAdapter extends RecyclerView.Adapter<PostListRecyclerViewAdapter.ViewHolder> {
    ...
    public PostListRecyclerViewAdapter(List<PlaceholderItem> items) {
        mValues = items;
    }
